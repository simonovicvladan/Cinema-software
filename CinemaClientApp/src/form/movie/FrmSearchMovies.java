 ...
 */
public class FrmSearchMovies extends javax.swing.JPanel {

    /**
     * Creates new form FrmSearchMovies
     */
    ...
    private void initComponents() {
        ...
        pnlMovies.setBorder(javax.swing.BorderFactory.createTitledBorder("Movies"));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        try {
            ...
            Communication.getInstance().sendRequest(new Request(Operation.OPERATION_SEARCH_MOVIES, keyword));
            Response response = Communication.getInstance().readResponse();
            if (response.getStatus() == ResponseStatus.OK) {
                TableModelMovie model = (TableModelMovie) tblMovies.getModel();
                List<Movie> movies = (List<Movie>) response.getData();
                model.setMovies(movies);
                for (Movie movie : movies) {
                    System.out.println(movie);
                }
                if (movies.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Movies with keyword " + keyword + " not found!",
                            "Search error", JOptionPane.ERROR_MESSAGE);
                    model.setMovies(new ArrayList<>());
                    return;
                }
                JOptionPane.showMessageDialog(this, "Movies with keyword " + keyword + " are found!");
                model.fireTableDataChanged();
            } else {
                JOptionPane.showMessageDialog(this, "Movies not found!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void btnDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailsActionPerformed
        ...
        if (selectedRow != -1) {
            Movie movie = model.getMovies().get(selectedRow);
            Session.getInstance().getUseCaseParams().clear();
            Session.getInstance().getUseCaseParams().put("movieID", movie);

            FrmMovie frmMovie = new FrmMovie(null, true, FrmMode.VIEW);
            frmMovie.setVisible(true);
            frmMovie.setLocationRelativeTo(null);
        } else {
            JOptionPane.showMessageDialog(this, "Movie is not selected!", "Details error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            if (selectedRow != -1) {
                Movie movie = model.getMovies().get(selectedRow);
                int result = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete movie " + movie + "?", "Question", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                if (result == JOptionPane.YES_OPTION) {
                    Controller.getInstance().deleteMovie(movie);
                    JOptionPane.showMessageDialog(this, "Movie " + movie + " has been deleted!");
                ...
                JOptionPane.showMessageDialog(this, "Movie is not selected!", "Delete error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            if (e instanceof BatchUpdateException) {
                JOptionPane.showMessageDialog(this, "Movie cannot be deleted because there is a projection of that movie.",
                        "Delete error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            System.out.println(e.getMessage());
            JOptionPane.showMessageDialog(this, "Movie has not been deleted!", "Delete error", JOptionPane.ERROR_MESSAGE);
    ...
    private void prepareTableMovie() {
        try {
            List<Movie> allMovies = Controller.getInstance().getAllMovies();
            TableModelMovie model = new TableModelMovie(allMovies);
